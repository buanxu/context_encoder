...
def resize_pic(inputDir, outDir, width, height):
    # 提取指定目录下的所有图片的全路径名
...
if __name__ == '__main__':
    inputDir="D:\PyCharm Community Edition 2021.1.1\worksapce\Region-wise-Inpainting-master\dataset\/test\/*.jpg"
    outDir="../context_encoder/outDir/"
    resize_pic(inputDir, outDir, 256, 256)